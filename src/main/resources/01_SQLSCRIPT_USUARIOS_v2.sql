-- ## TIPOS DE USU�RIOS: ADMINISTRADOR, ALUNO, SECRETARIA, PEDAGOGO; ## --
...
INSERT INTO endereco(id, cep, complemento, logradouro, numero, bairro_id) VALUES (nextval('endereco_id_seq'), 29042715, null, 'AVENIDA MARECHAL CAMPOS', 1355, getIdBairro('Santos Dumont', 'Vit�ria', 'ES'));
