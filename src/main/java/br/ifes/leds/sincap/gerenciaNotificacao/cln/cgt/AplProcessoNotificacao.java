...
public class AplProcessoNotificacao {
     ...
     * @param processoNotificacaoDTO - ProcessoNotificacao - Notificacao que sera salva 
    ...
    */
    ...
    /**
     * Metodo que salva uma nova entrevista vinculada a um Processo de Notificacao
    ...
    /**
     * Metodo que atualiza o Processo de Notificacao,
     * essa etapa irá acontecer: 
     ...
     * @param processoNotificacaoDTO - Processo de notificacao DTO
    ...
    */
    ...
    {
        List<ProcessoNotificacao> processoNotificacaos = 
                notificacaoRepository.findByDataAberturaBetween(DataAberturaIni, DataAberturaFim);
