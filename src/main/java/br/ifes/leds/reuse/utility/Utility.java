...
public class Utility {
    ...
    /**
     * @param calendar representa o a data salva na classe que precisa ser
     ...
     *
     * @param listaOrigem   A lista a ser mapeada.
     * @param classeDestino O tipo destino a ser mapeado.
     ...
     *
     * @param destination Objeto no qual os ids serão inseridos.
     * @param source      Objeto do qual os ids vem.
     * @param <T>         Tipo dos objetos que serão manipulados.
     */
    ...
    public static Calendar hoje() {
        return new DateTime().withTime(0, 0, 0, 0).toCalendar(Locale.getDefault());
    }
}
